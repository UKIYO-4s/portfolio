            ...
            <form class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <label class="glass-card-minimal p-3 cursor-pointer hover:bg-white/80 transition-colors flex items-center justify-center text-center">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        class="w-full rounded-xl border border-[rgba(0,0,0,0.08)] bg-white/50 px-4 py-3 text-sm text-[#121212] placeholder-[#6B6B6B] focus:outline-none focus:ring-2 focus:ring-[#1F3A2E]/20 focus:border-[#1F3A2E]/30 transition-all"
