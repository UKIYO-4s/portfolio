...
<section class="min-h-screen flex items-center justify-center px-6 lg:px-8 py-20">
    <div class="max-w-5xl mx-auto text-center">
        <div class="glass-card p-12 md:p-16 mb-12 animate-fade-in">
            <h1 class="text-6xl md:text-7xl lg:text-8xl font-light text-gray-900 mb-8 leading-tight tracking-tight">
                Design meets<br>
                Technology
            </h1>
            <p class="text-lg md:text-xl text-gray-600 font-light leading-relaxed max-w-2xl mx-auto mb-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a href="{{ route('demo.custom-hp.works') }}" class="glass-button px-10 py-4 rounded-full text-sm font-light inline-block">
                    実績を見る
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="glass-card glass-card-hover rounded-3xl p-8">
                <div class="mb-6">
                    <div class="icon-pill icon-grad-sky mb-6">
            ...
            <div class="glass-card glass-card-hover rounded-3xl p-8">
                <div class="mb-6">
                    <div class="icon-pill icon-grad-emerald mb-6">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="glass-card glass-card-hover rounded-3xl p-8">
                <div class="mb-6">
                    <div class="icon-pill icon-grad-violet mb-6">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('demo.custom-hp.service') }}" class="glass-button px-8 py-3 rounded-full text-sm font-light inline-block">
                サービス一覧を見る →
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="glass-card glass-card-hover rounded-3xl overflow-hidden">
                <div class="aspect-video bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center">
                    <div class="text-center">
                        <svg class="w-16 h-16 mx-auto text-white/70 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <p class="text-white/60 text-xs font-light">Work Image</p>
                    </div>
                </div>
                <div class="p-8">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="text-xs font-light px-3 py-1 rounded-full bg-gray-100 text-gray-700">Web開発</span>
            ...
            <div class="glass-card glass-card-hover rounded-3xl overflow-hidden">
                ...
                <div class="p-8">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="text-xs font-light px-3 py-1 rounded-full bg-gray-100 text-gray-700">Webデザイン</span>
                        <span class="text-xs font-light text-gray-500">2024</span>
                    </div>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('demo.custom-hp.works') }}" class="glass-button px-8 py-3 rounded-full text-sm font-light inline-block">
                実績一覧を見る →
            </a>
        </div>
    </div>
