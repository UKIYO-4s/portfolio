...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>{{ $type == 'invoice' ? '請求書' : '見積書' }}作成</h2>
    <a href="{{ route('demo.invoice.invoices.index') }}" class="btn btn-secondary">戻る</a>
</div>

<div class="row">
    <div class="col-lg-12">
        <form onsubmit="alert('この機能はデモです。実際のデータは保存されません。'); return false;" id="documentForm">
            <div class="card mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="例: SD-Create宛 請求書">
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <textarea class="form-control" rows="3" placeholder="備考を入力してください"></textarea>
                </div>
            </div>
