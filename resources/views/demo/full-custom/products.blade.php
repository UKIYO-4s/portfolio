            ...
            <div class="{{ $bgColors[$index % 6] }} p-6 rounded-2xl border-4 border-gray-800 retro-shadow bounce-hover-subtle">
                ...
                <div class="aspect-square bg-white rounded-xl border-4 border-gray-800 mb-6 flex items-center justify-center">
                    <div class="text-center text-gray-400">
                        ...
                        <p class="text-gray-500 font-bold text-sm mt-2">Product Image</p>
                    </div>
                </div>
...
<div class="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
    <div class="bg-gradient-to-r from-cyan-400 to-orange-400 p-12 rounded-3xl border-4 border-gray-800 retro-shadow text-center">
