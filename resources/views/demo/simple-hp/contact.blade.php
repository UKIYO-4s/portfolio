...
<section class="py-16 md:py-20 bg-gradient-to-br from-gray-50 via-emerald-50/30 to-gray-50">
    <div class="max-w-6xl mx-auto px-6 md:px-8 text-center">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">お問い合わせ</h1>
...
<section class="py-16 md:py-20 bg-white">
    <div class="max-w-2xl mx-auto px-6 md:px-8">
        <div class="text-center mb-10">
            <p class="text-gray-600 leading-relaxed">
                サービスに関するご質問、お見積もりのご依頼など、お気軽にお問い合わせください。<br class="hidden sm:block">
                2営業日以内にご連絡いたします。
            </p>
        </div>

        <form onsubmit="event.preventDefault(); alert('この機能はデモです。実際の送信は行われません。');" class="bg-gradient-to-br from-gray-50 via-emerald-50/20 to-gray-50 p-6 md:p-10 rounded-2xl shadow-lg border border-gray-200">
            <div class="space-y-6">
                <!-- Company -->
                <div>
...
<section class="py-16 md:py-20 bg-gradient-to-br from-gray-50 via-emerald-50/30 to-gray-50">
    <div class="max-w-4xl mx-auto px-6 md:px-8">
        <div class="text-center mb-10">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4">その他の連絡方法</h2>
            <div class="w-16 h-1 bg-emerald-600 mx-auto"></div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <!-- Email Card -->
            <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-200 text-center hover:shadow-lg transition-shadow duration-300">
                <div class="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                </div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">メール</h3>
                <p class="text-gray-600 text-sm mb-4">お気軽にメールでご連絡ください</p>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-200 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">営業時間</h3>
                <p class="text-gray-600 text-sm mb-2">平日 10:00 - 18:00</p>
                <p class="text-xs text-gray-500">（土日祝日は休業）</p>
            </div>
        </div>

        <!-- Address -->
        <div class="mt-6 md:mt-8 bg-white p-6 rounded-2xl shadow-md border border-gray-200 text-center hover:shadow-lg transition-shadow duration-300">
            <div class="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">所在地</h3>
