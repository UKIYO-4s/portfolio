...
<section class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onsubmit="event.preventDefault(); alert('この機能はデモです。実際の送信は行われません。');" class="bg-gray-50 p-8 rounded-lg shadow-md border border-gray-100">
            <!-- Name -->
            <div class="mb-6">
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-2xl font-bold text-gray-900 text-center mb-12">その他のお問い合わせ方法</h2>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="text-center p-6 bg-white rounded-lg shadow-md">
                ...
                <h3 class="font-semibold text-gray-900 mb-2">お電話</h3>
                <p class="text-gray-600 text-sm mb-2">平日 9:00-18:00</p>
                <a href="tel:03-1234-5678" class="text-blue-600 font-semibold hover:underline">03-1234-5678</a>
            </div>
            ...
            <div class="text-center p-6 bg-white rounded-lg shadow-md">
                ...
                <h3 class="font-semibold text-gray-900 mb-2">メール</h3>
                <p class="text-gray-600 text-sm mb-2">24時間受付</p>
                <a href="mailto:info@sample-corp.jp" class="text-blue-600 font-semibold hover:underline">info@sample-corp.jp</a>
            </div>
            ...
            <div class="text-center p-6 bg-white rounded-lg shadow-md">
                ...
                <h3 class="font-semibold text-gray-900 mb-2">オフィス</h3>
