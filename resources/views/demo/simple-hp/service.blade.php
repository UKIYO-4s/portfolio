            ...
            @foreach($services as $index => $service)
                <div class="grid md:grid-cols-2 gap-8 items-center {{ $index % 2 == 1 ? 'md:flex-row-reverse' : '' }}">
                    ...
                    <div class="{{ $index % 2 == 1 ? 'md:order-2' : '' }}">
                        <div class="inline-block px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-sm font-medium mb-4">
                            Service {{ $index + 1 }}
                        </div>
                        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ $service['title'] }}</h2>
                        <p class="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                            {{ $service['description'] }}
                        </p>

                        <h3 class="font-semibold text-gray-900 dark:text-white mb-3">主な特徴</h3>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div>
                                <p class="text-sm text-gray-500 dark:text-gray-400">料金</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $service['price'] }}</p>
                            </div>
...
<section class="py-16 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">お気軽にご相談ください</h2>
