...
<body class="bg-white">
    <!-- Header -->
    <header class="w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        <div class="max-w-6xl mx-auto px-6 md:px-8">
            <div class="flex justify-between items-center h-20">
                <!-- Logo -->
                <div class="flex-shrink-0">
                    <a href="{{ route('demo.simple-hp.index') }}" class="text-xl md:text-2xl font-semibold text-gray-900 hover:text-gray-700 transition-colors">
                        Greenline Studio
                    </a>
                </div>
    ...
    <!-- Demo Notice -->
    <div class="w-full bg-yellow-50 border-b border-yellow-200">
        <div class="max-w-6xl mx-auto px-6 md:px-8 py-3">
    ...
    <!-- Footer -->
    <footer class="w-full bg-gray-900 text-gray-300 mt-16 md:mt-20">
        <div class="max-w-6xl mx-auto px-6 md:px-8 py-12 md:py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <!-- Company Info -->
                <div>
                    <h3 class="text-lg font-semibold text-white mb-4">Greenline Studio</h3>
                ...
                <!-- Links -->
                <div>
                    <h3 class="text-lg font-semibold text-white mb-4">サイトマップ</h3>
                ...
                <!-- Quick Contact -->
                <div>
                    <h3 class="text-lg font-semibold text-white mb-4">お問い合わせ</h3>
        ...
        <div class="border-t border-gray-800 bg-gray-950">
            <div class="max-w-6xl mx-auto px-6 md:px-8 py-4 text-center">
