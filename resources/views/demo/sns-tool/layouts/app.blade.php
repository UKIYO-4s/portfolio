...
<body class="antialiased">
    ...
    <div id="sidebar" class="mobile-menu lg:translate-x-0 fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 overflow-y-auto z-40">
        ...
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-xs text-gray-500 mt-1">Social Media Tool</p>
        </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100 bg-gray-50">
            <p class="text-xs text-gray-500 mb-2">Demo Mode</p>
    ...
    <div class="lg:ml-64">
        ...
        <header class="bg-white border-b border-gray-200 sticky top-0 z-20">
            <div class="px-4 lg:px-8 py-4 flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900 ml-12 lg:ml-0">@yield('page-title', 'Dashboard')</h2>
        ...
        <footer class="bg-white border-t border-gray-200 py-6">
            <div class="px-4 lg:px-8">
                <p class="text-sm text-gray-500 text-center">
                    SNS Manager Demo - Social Media Management Tool
                </p>
                <p class="text-xs text-gray-400 text-center mt-2">
                    This is a demo. Features are for demonstration purposes only.
                </p>
            </div>
        </footer>
    </div>
