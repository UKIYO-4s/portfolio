...
<div class="py-24 px-6 sm:px-8 lg:px-12 max-w-3xl mx-auto">
    <div class="text-center mb-12">
        ...
        <p class="text-gray-400">ご購入ありがとうございます。以下からダウンロードしてください。</p>
    ...
    <div class="bg-gray-900/50 border border-gray-800 p-8 mb-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <!-- Apple Silicon -->
            <a href="{{ \App\Http\Controllers\DownloadController::generateSignedFileUrl($order, $product, 'arm64') }}"
            ...
            <!-- Intel -->
            <a href="{{ \App\Http\Controllers\DownloadController::generateSignedFileUrl($order, $product, 'x64') }}"
               class="block p-6 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-blue-500 transition-all group">
                <div class="text-center">
                    <div class="mb-4">
                        <svg class="w-12 h-12 mx-auto text-gray-400 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gray-800 p-6 rounded">
        <h3 class="font-medium mb-3">注文情報</h3>
        <div class="text-sm text-gray-400 space-y-1">
            <p>注文番号: <span class="text-white font-mono">{{ $order->order_number }}</span></p>
            <p>メール: <span class="text-white">{{ $order->email }}</span></p>
            <p>ダウンロード有効期限: <span class="text-white">{{ $expiresAt->format('Y年m月d日') }}</span></p>
        </div>
    </div>

    {{-- 利用規約・法的警告 --}}
    <div class="mt-4 p-5 bg-red-900/20 border border-red-800 rounded">
    ...
    <div class="mt-4 p-4 bg-gray-900 border border-gray-700 rounded text-sm text-gray-400">
        <p>有効期限を過ぎた場合は、サポートまでお問い合わせください。</p>
    </div>
